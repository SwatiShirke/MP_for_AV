...
def main():
    ...
    obs_transform2 = carla.Transform(
        carla.Location(x=-48.644844, y=28.471010, z=0.6),
        carla.Rotation(yaw=180)
    )    

    obstacle_vehicle2 = world.spawn_actor(obs_bp2, obs_transform2)
    ...
    obs_transform3   = carla.Transform(
        carla.Location(x=-48.644844, y=20.471010, z=0.6),
        carla.Rotation(yaw=180)
    )    

    obstacle_vehicle3 = world.spawn_actor(obs_bp3, obs_transform3)
