...
class IMU(Node):
    def __init__(self, VEHICLE_ROLE_NAME):
        ...
        imu_bp.set_attribute('noise_accel_stddev_x', str(0.0005))  # 100 mug /s^2/root(hz)
        imu_bp.set_attribute('noise_accel_stddev_y', str(0.0005))    
        imu_bp.set_attribute('noise_gyro_stddev_z', str(0.01 *3.14/180))  #0.008 / pi/180      = 0.008 * 3.14/180     
        imu_bp.set_attribute('noise_gyro_bias_z', str((0.25 * 3.14/180)/ 3600))   #5 degrre /hr
