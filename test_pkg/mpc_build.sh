...
cd ..
cp scripts/c_generated_code/ackerman_model_model/ackerman_model_model.h include/test_pkg
cp scripts/c_generated_code/acados_solver_ackerman_model.h include/test_pkg
...
cp scripts/cbf_solver.h include/test_pkg
