...
static const casadi_int casadi_s1[13] = {4, 4, 0, 1, 2, 4, 6, 0, 1, 0, 2, 1, 3};
...
static int casadi_f1(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  a15=(-a15);
  if (res[3]!=0) res[3][20]=a15;
  a17=(-a17);
  if (res[3]!=0) res[3][21]=a17;
  a3=(-a3);
  if (res[3]!=0) res[3][22]=a3;
  a14=(-a14);
  if (res[3]!=0) res[3][23]=a14;
  return 0;
}
...
/* nlp_hess_l:(x[4],p[24],lam_f,lam_g[8])->(triu_hess_gamma_x_x[4x4,6nz]) */
...
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  ...
  AddIpoptStrOption(d->ipopt, "linear_solver","ma27");
