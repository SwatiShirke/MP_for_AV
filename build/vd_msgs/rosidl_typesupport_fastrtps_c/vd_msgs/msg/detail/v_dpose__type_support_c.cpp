...
#include "vd_msgs/msg/detail/v_dpose__rosidl_typesupport_fastrtps_c.h"
...
using _VDpose__ros_msg_type = vd_msgs__msg__VDpose;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _VDpose__ros_msg_type * ros_message = static_cast<const _VDpose__ros_msg_type *>(untyped_ros_message);
  // Field name: s
  {
    cdr << ros_message->s;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _VDpose__ros_msg_type * ros_message = static_cast<_VDpose__ros_msg_type *>(untyped_ros_message);
  // Field name: s
  {
    cdr >> ros_message->s;
  }
...
static uint32_t _VDpose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vd_msgs__msg__VDpose(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vd_msgs__msg__VDpose;
    is_plain =
      (
...
static size_t _VDpose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vd_msgs__msg__VDpose(
...
static message_type_support_callbacks_t __callbacks_VDpose = {
  "vd_msgs::msg",
  "VDpose",
...
static rosidl_message_type_support_t _VDpose__type_support = {
