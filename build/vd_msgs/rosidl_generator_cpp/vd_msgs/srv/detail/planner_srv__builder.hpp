...
class Init_PlannerSrv_Request_yaw
{
public:
  explicit Init_PlannerSrv_Request_yaw(::vd_msgs::srv::PlannerSrv_Request & msg)
  : msg_(msg)
  {}
  ::vd_msgs::srv::PlannerSrv_Request yaw(::vd_msgs::srv::PlannerSrv_Request::_yaw_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_PlannerSrv_Request_yaw y(::vd_msgs::srv::PlannerSrv_Request::_y_type arg)
  {
    msg_.y = std::move(arg);
    return Init_PlannerSrv_Request_yaw(msg_);
  }
