...
static const _VDstate_type_support_symbol_names_t _VDstate_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vd_msgs, msg, VDstate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vd_msgs, msg, VDstate)),
  }
};
...
{
  return &::vd_msgs::msg::rosidl_typesupport_cpp::VDstate_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vd_msgs, msg, VDstate)() {
  return get_message_type_support_handle<vd_msgs::msg::VDstate>();
}
