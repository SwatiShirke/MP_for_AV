...
#include "vd_carla_msgs/msg/detail/carla_ego_vehicle_control__rosidl_typesupport_fastrtps_c.h"
...
#include "vd_carla_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_vd_carla_msgs
...
using _CarlaEgoVehicleControl__ros_msg_type = vd_carla_msgs__msg__CarlaEgoVehicleControl;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vd_carla_msgs
size_t get_serialized_size_vd_carla_msgs__msg__CarlaEgoVehicleControl(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CarlaEgoVehicleControl__ros_msg_type * ros_message = static_cast<const _CarlaEgoVehicleControl__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CarlaEgoVehicleControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vd_carla_msgs__msg__CarlaEgoVehicleControl(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vd_carla_msgs
size_t max_serialized_size_vd_carla_msgs__msg__CarlaEgoVehicleControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vd_carla_msgs__msg__CarlaEgoVehicleControl;
    is_plain =
      (
...
static size_t _CarlaEgoVehicleControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vd_carla_msgs__msg__CarlaEgoVehicleControl(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vd_carla_msgs, msg, CarlaEgoVehicleControl)() {
