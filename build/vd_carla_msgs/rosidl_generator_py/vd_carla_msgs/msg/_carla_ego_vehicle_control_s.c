...
bool vd_carla_msgs__msg__carla_ego_vehicle_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vd_carla_msgs.msg._carla_ego_vehicle_control.CarlaEgoVehicleControl", full_classname_dest, 67) == 0);
  }
  vd_carla_msgs__msg__CarlaEgoVehicleControl * ros_message = _ros_message;
  {  // header
...
PyObject * vd_carla_msgs__msg__carla_ego_vehicle_control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vd_carla_msgs.msg._carla_ego_vehicle_control");
