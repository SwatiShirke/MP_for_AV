...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VDControlCMD_message_member_array[3] = {
  {
    "acceleration",  // name
    ...
    offsetof(vd_msgs::msg::VDControlCMD, acceleration),  // bytes offset in struct
