...
{
public:
  explicit Init_VDControlCMD_velocity(::vd_msgs::msg::VDControlCMD & msg)
  : msg_(msg)
  {}
  ::vd_msgs::msg::VDControlCMD velocity(::vd_msgs::msg::VDControlCMD::_velocity_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_VDControlCMD_velocity steering_angle(::vd_msgs::msg::VDControlCMD::_steering_angle_type arg)
  {
    msg_.steering_angle = std::move(arg);
    return Init_VDControlCMD_velocity(msg_);
  }
...
class Init_VDControlCMD_acceleration
{
public:
  Init_VDControlCMD_acceleration()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_VDControlCMD_steering_angle acceleration(::vd_msgs::msg::VDControlCMD::_acceleration_type arg)
  {
...
{
  return vd_msgs::msg::builder::Init_VDControlCMD_acceleration();
}
