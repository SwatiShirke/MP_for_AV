...
#ifndef VD_MSGS__SRV__DETAIL__PLANNER_SRV__FUNCTIONS_H_
#define VD_MSGS__SRV__DETAIL__PLANNER_SRV__FUNCTIONS_H_
...
/// Initialize srv/PlannerSrv message.
/**
...
/// Finalize srv/PlannerSrv message.
/**
...
/// Create srv/PlannerSrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vd_msgs__srv__PlannerSrv_Request__init().
...
/// Destroy srv/PlannerSrv message.
/**
 * It calls
 * vd_msgs__srv__PlannerSrv_Request__fini()
...
/// Check for srv/PlannerSrv message equality.
/**
...
/// Initialize array of srv/PlannerSrv messages.
/**
...
/// Finalize array of srv/PlannerSrv messages.
/**
 * It calls
 * vd_msgs__srv__PlannerSrv_Request__fini()
...
/// Create array of srv/PlannerSrv messages.
/**
 * It allocates the memory for the array and calls
 * vd_msgs__srv__PlannerSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PlannerSrv messages.
/**
 * It calls
 * vd_msgs__srv__PlannerSrv_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PlannerSrv message array equality.
/**
...
/// Copy an array of srv/PlannerSrv messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vd_msgs__srv__PlannerSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vd_msgs
...
/**
 * It calls
 * vd_msgs__srv__PlannerSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_vd_msgs
...
/**
 * It allocates the memory for the array and calls
 * vd_msgs__srv__PlannerSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vd_msgs
...
/**
 * It calls
 * vd_msgs__srv__PlannerSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VD_MSGS__SRV__DETAIL__PLANNER_SRV__FUNCTIONS_H_
